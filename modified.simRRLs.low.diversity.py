...
###Edits by JBP
#Changed simulation to include migration within population pairs and to include proper fusion events to model tree above
paramSet = egglib.simul.CoalesceParamSet(singleSamples=None, doubleSamples=[A,B,C,D,X],M=0.0)
"clade 1"
